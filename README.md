# Inner Savages webpage
This project is based on DevBlog template created by Ryan Fitzgerald and Gatsby site generator. Following description comes from the original repository, which can be found  [here](https://github.com/RyanFitzgerald/devblog).

Template has been adapted for the needs of [Inner Savages](https://innersavages.pl) association.
